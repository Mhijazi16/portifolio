...
const App: React.FC = () => {
  return (
    <div className="relative min-h-screen text-white selection:bg-blue-500 selection:text-white overflow-hidden">
      {/* Blurred gradient background */}
      <div className="fixed inset-0 -z-10">
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-blue-500/25 rounded-full blur-3xl" />
        <div className="absolute top-1/3 -right-32 w-[28rem] h-[28rem] bg-purple-500/25 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 left-1/4 w-[32rem] h-[32rem] bg-emerald-500/20 rounded-full blur-3xl" />
